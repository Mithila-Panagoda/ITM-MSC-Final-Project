...
SWAGGER_ADMIN_LOGIN_ENABLED = (
    os.environ.get("SWAGGER_ADMIN_LOGIN_ENABLED", "false").lower() == "true"
)
SWAGGER_SETTINGS = {
...
SIMPLE_JWT = {
    "ACCESS_TOKEN_LIFETIME": timedelta(
        hours=os.environ.get("SIMPLE_JWT_ACCESS_TOKEN_LIFETIME", 5)
    ),
    "REFRESH_TOKEN_LIFETIME": timedelta(
        days=os.environ.get("SIMPLE_JWT_REFRESH_TOKEN_LIFETIME", 30)
    ),
}
# Password validation
...
OVERRIDE_DEFAULT_STORAGE_IN_DEBUG = os.getenv(
    "DJANGO_OVERRIDE_DEFAULT_STORAGE_IN_DEBUG", True
)
